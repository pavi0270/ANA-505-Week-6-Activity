...
#An advantage of KMeans is that it is computationally very fast. A disadvantage of the 
#same is that it does not work too well with clusters of different sizes.#Clustering helps identify and group similar data points in larger datasets 
#without concern for the specific outcome. You can see 88% of our data was predicted accurately which is pretty good for 
#an unsupervised algorithm.

#TASK: Accuracy = number of correctly classified/(total classified) = ?
#i.e our model has achieved ?% accuracy! 88%
